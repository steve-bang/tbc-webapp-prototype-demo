...
export const vi = {
  ...
  rentals: {
    ...
    noValue: 'Chưa có',
    // Round 2 — Rental Detail (`/rentals/:id`), 8 tab (docs/RENTAL-MANAGEMENT-PLAN.md §15.2).
    tabOverview: 'Tổng quan',
    tabPricing: 'Giá, cọc & phát sinh',
    tabPayment: 'Thanh toán',
    tabContract: 'Hợp đồng',
    tabHandoverReturn: 'Giao/nhận',
    tabIncidents: 'Sự cố',
    tabAssignment: 'Phân công',
    tabAudit: 'Nhật ký thao tác',
    ...
    auditColumnAction: 'Hành động',
    auditColumnActor: 'Người thực hiện',
    // Tab "Hợp đồng" (`RentalContractTab` — `docs/CONTRACT-MANAGEMENT-PLAN.md` §5.1).
    contractTabCreateButton: 'Sinh hợp đồng',
    contractTabNotConfirmedNotice: 'Chỉ sinh được hợp đồng khi lượt thuê đã Xác nhận.',
    contractTabEmptyNotice: 'Chưa có hợp đồng cho lượt thuê này.',
    contractTabCode: 'Mã hợp đồng',
    contractTabGeneratedAt: 'Ngày sinh',
    contractTabViewDetail: 'Xem chi tiết hợp đồng',
    contractCreateSuccess: 'Đã sinh hợp đồng.',
    contractCreateError: 'Không thể sinh hợp đồng, vui lòng thử lại.',
  },
  contracts: {
    title: 'Hợp đồng',
    description: 'Theo dõi hợp đồng thuê xe được sinh từ các lượt thuê đã xác nhận.',
    searchPlaceholder: 'Tìm theo mã hợp đồng, tên khách hoặc biển số xe',
    filterStatus: 'Trạng thái',
    filterAllStatuses: 'Tất cả trạng thái',
    columnCode: 'Mã hợp đồng',
    columnCustomer: 'Khách hàng',
    columnVehicle: 'Xe',
    columnCreatedAt: 'Ngày sinh',
    emptyFiltered: 'Không tìm thấy hợp đồng phù hợp. Thử xoá bớt bộ lọc.',
    emptyAll: 'Chưa có hợp đồng nào. Hợp đồng được sinh từ tab "Hợp đồng" ở chi tiết lượt thuê đã Xác nhận.',
    notFound: 'Không tìm thấy hợp đồng.',
    noValue: 'Chưa có',
    // Header actions (Detail).
    previewAction: 'Xem trước / Xuất PDF',
    signAction: 'Tải lên bản ký',
    voidAction: 'Huỷ hợp đồng',
    // 4 tab (§5.3 kế hoạch).
    tabOverview: 'Tổng quan',
    tabSignedCopy: 'Bản ký',
    tabAddendums: 'Phụ lục',
    tabAudit: 'Nhật ký thao tác',
    // Tab Tổng quan — nhóm Snapshot Data.
    sectionCompany: 'Bên cho thuê',
    sectionCustomer: 'Bên thuê (khách hàng)',
    sectionVehicle: 'Xe cho thuê',
    sectionPeriod: 'Thời gian thuê',
    sectionLocation: 'Địa điểm giao/nhận',
    sectionPricing: 'Giá thuê',
    sectionDeposit: 'Đặt cọc',
    companyName: 'Tên công ty',
    customerName: 'Họ tên',
    customerIdNumber: 'Số CCCD/Hộ chiếu',
    ...
    pickupLocation: 'Địa điểm giao xe',
    returnLocation: 'Địa điểm nhận xe',
    rentalRate: 'Đơn giá thuê',
    rentalDurationDays: 'Số ngày thuê',
    baseAmount: 'Base Amount',
    discountAmount: 'Giảm giá',
    estimatedTotal: 'Tổng tạm tính',
    prepaymentAmount: 'Prepayment (30% Base Rental)',
    allowedKm: 'Allowed KM',
    pricePerKm: 'Price Per KM',
    securityDepositType: 'Hình thức đặt cọc',
    securityDepositAmount: 'Số tiền đặt cọc',
    linkToRental: 'Xem lượt thuê gốc',
    // Tab Bản ký.
    signedEmpty: 'Chưa có bản ký.',
    signedCopyFileName: 'Tên file bản ký',
    signedDate: 'Ngày ký',
    signedByCompany: 'Người ký đại diện công ty',
    signedByCustomer: 'Người ký đại diện khách hàng',
    // Dialog "Xem trước / Xuất PDF" (§5.4 kế hoạch — giả lập, chưa có mẫu thật).
    previewDialogTitle: 'Xem trước hợp đồng',
    previewDialogNote: 'Bản xem trước giả lập — chưa tích hợp mẫu hợp đồng/xuất PDF thật.',
    exportPdfButton: 'Xuất PDF',
    exportPdfSuccess: 'Đã xuất PDF (giả lập).',
    // Dialog "Tải lên bản ký" (giả lập, không upload file thật).
    signDialogTitle: 'Tải lên bản ký',
    signSuccess: 'Đã ghi nhận bản ký.',
    signError: 'Không thể ghi nhận bản ký, vui lòng thử lại.',
    // Dialog "Huỷ hợp đồng".
    voidDialogTitle: 'Huỷ hợp đồng',
    voidReasonLabel: 'Lý do huỷ',
    voidSuccess: 'Đã huỷ hợp đồng.',
    voidError: 'Không thể huỷ hợp đồng, vui lòng thử lại.',
    voidedInfo: 'Lý do huỷ',
    // Tab Phụ lục (đọc-only — §1.2 kế hoạch, không có form tạo).
    addendumEmpty: 'Chưa phát sinh phụ lục nào cho hợp đồng này.',
    addendumColumnType: 'Loại phụ lục',
    addendumColumnEffectiveDate: 'Ngày hiệu lực',
    addendumColumnDescription: 'Nội dung',
    // Tab Nhật ký thao tác.
    auditEmpty: 'Chưa có thao tác nào được ghi nhận cho hợp đồng này.',
    auditColumnAt: 'Thời gian',
    auditColumnAction: 'Hành động',
    auditColumnActor: 'Người thực hiện',
  },
...
export const CONTRACT_ADDENDUM_TYPE_LABELS: Record<ContractAddendumType, string> = {
  ADDENDUM_VEHICLE_SWAP: 'Phụ lục đổi xe',
