...
/** `VM §16.1`/CR-2026-046 — hiển thị hiệu lực giấy tờ (dựa trên `documentExpiryStatus()` dùng chung). */
...
export function VehicleDocumentStatusBadge({ status }: { status: DocumentStatus }) {
