...
/**
 * `VM §16.1` — list `VehicleDocument` của một xe + CRUD. Viết độc lập, không
 * phụ thuộc route Vehicle Detail — Round 2 sẽ import thẳng vào tab Documents
 * mà không sửa lại (VEHICLE-MANAGEMENT-PLAN.md §5.3). Không có nút Xoá — BRD
 * §16.1 yêu cầu giữ lịch sử.
 */
